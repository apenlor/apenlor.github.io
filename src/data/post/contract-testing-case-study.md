...
[Watch on YouTube: Reducing the cost of testing in application modernization](https://www.youtube.com/watch?v=LyVSmRtwFkc)
...
On the other hand, if you're interested in learning more about how we manage the onboarding process for each team, check out the 'Onboarding New Teams' section in the <a href="/blog/contract-testing-and-development#onboarding-new-teams" target="_blank">Contract Testing & Development article</a>.
