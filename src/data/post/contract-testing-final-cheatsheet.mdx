...
image: ~/assets/images/cover-contract-testing-cheatsheet.png
tags:
  - Adoption
  - PactFlow
  - pact
...
import diagramConsumerDriven from "~/assets/images/diagram-contract-testing-cheatsheet-consumer-driven.png";
import diagramBidirectional from "~/assets/images/diagram-contract-testing-cheatsheet-bidirectional.png";
import diagramConsumerPipeline from "~/assets/images/diagram-contract-testing-cheatsheet-consumer-pipeline.png";
import diagramProviderPipeline from "~/assets/images/diagram-contract-testing-cheatsheet-provider-pipeline.png";
import diagramBidirectionalPipeline from "~/assets/images/diagram-contract-testing-cheatsheet-bidirectional-pipeline.png";
...
<Image src={diagramConsumerDriven} alt="Consumer Driven diagram" />
...
<Image src={diagramBidirectional} alt="Bidirectional diagram" />
...
- [Bi-directional Contract Testing](https://support.smartbear.com/swagger/contract-testing/docs/en/user-guide/contract-testing/bi-directional-contract-testing/overview.html)
- [Contract Testing Examples](https://support.smartbear.com/swagger/contract-testing/docs/en/examples.html)
...
- [Contract Testing Workflows](/blog/contract-testing-workflows)
- [Contract Testing & CI](/blog/contract-testing-and-ci)
...
<Image src={diagramConsumerPipeline} alt="Consumer Driven pipeline diagram" />

For the provider, the verification is usually done by delegating on the pact plugin executed within the build:

<Image
  src={diagramProviderPipeline}
  alt="Consumer Driven, provider pipeline diagram"
/>
...
<Image
  src={diagramBidirectionalPipeline}
  alt="Bidirectional pipeline diagram"
/>
