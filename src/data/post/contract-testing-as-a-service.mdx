...
image: ~/assets/images/cover-contract-testing-aas.png
tags:
  - Adoption
  - PactFlow
---
...
import diagramContractTestingAas from "~/assets/images/diagram-contract-testing-aas.png";
...
<Image
  src={diagramContractTestingAas}
  widths={[400, 1024]}
  sizes="(max-width: 1024px) 400px, 1024px"
  alt="Contract Testing as a Service diagram"
  class="mx-auto"
/>
...
Let me do a bit of self-promotion and invite you to read [this article about consumer-driven workflows in Contract Testing](/blog/contract-testing-workflows).
