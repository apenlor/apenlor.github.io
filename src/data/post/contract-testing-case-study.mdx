...
image: ~/assets/images/cover-contract-testing-case-study.png
tags:
  - Adoption
  - PactFlow
---
...
import diagramMvpCaseStudy from "~/assets/images/diagram-mvp-case-study.png";
...
For those interested in a deeper dive, I also have a [YouTube collaboration with the PactFlow team](https://www.youtube.com/watch?v=LyVSmRtwFkc) that goes over the same business case and analyzes all these points in detail with our colleagues from PactFlow.

<div class="mx-auto max-w-2xl">
  <YouTube
    id="https://www.youtube.com/watch?v=LyVSmRtwFkc"
    title="Reducing the cost of testing in application modernization"
  />
</div>

## Challenge

In today's fast-paced tech environment, companies must optimize their delivery pipelines to remain competitive. The need for rapid deployment, cost reduction, and increased team confidence has driven many to embrace early bug detection and automation (I'm pretty fan of [Shift-Left Testing](https://en.wikipedia.org/wiki/Shift-left_testing) 😊).
...
<Image
  src={diagramMvpCaseStudy}
  widths={[400, 1024]}
  sizes="(max-width: 1024px) 400px, 1024px"
  alt="MVP Planning diagram"
  class="mx-auto"
/>
...
On the other hand, if you're interested in learning more about how we manage the onboarding process for each team, check out the 'Onboarding New Teams' section in the [Contract Testing & Development article](/blog/contract-testing-and-development#onboarding-new-teams).
