...
image: ~/assets/images/cover-contract-testing-workflows.png
...
import diagramConsumerDrivenWorkflow from "~/assets/images/diagram-consumer-driven-workflow.png";
import diagramConsumerDeployNoImpactProvider from "~/assets/images/diagram-consumer-deploy-no-impact-provider.png";
import diagramProviderDeployNoImpactConsumer from "~/assets/images/diagram-provider-deploy-no-impact-consumer.png";
import diagramProviderDeployImpactConsumer from "~/assets/images/diagram-provider-deploy-impact-consumer.png";
...
- **Consumer Driven:** The flow is started (_and fully handled_) by the consumers. Providers must validate the contract, requiring them to include code in their testing phase. [Check out this article](https://dzone.com/articles/improve-microservice-testing-with-contract-testing) if you want more information.
- **Bi-directional:** For situations where there is no control over the provider's code (or maybe there is control, but there's no will to include new testing code in their source). We have published at Sngular [some nice articles related](https://www.sngular.com/the-easy-way-to-get-started-with-bi-directional-contract-testing/).
...
<Image
  src={diagramConsumerDrivenWorkflow}
  widths={[400, 1024]}
  sizes="(max-width: 1024px) 400px, 1024px"
  alt="Consumer Driven Workflow"
  class="mx-auto"
/>
...
<Image
  src={diagramConsumerDeployNoImpactProvider}
  widths={[400, 1024]}
  sizes="(max-width: 1024px) 400px, 1024px"
  alt="Consumer deployment without impact on provider"
  class="mx-auto"
/>
...
<Image
  src={diagramProviderDeployNoImpactConsumer}
  widths={[400, 1024]}
  sizes="(max-width: 1024px) 400px, 1024px"
  alt="Provider deployment without impact on consumer"
  class="mx-auto"
/>
...
<Image
  src={diagramProviderDeployImpactConsumer}
  widths={[400, 1024]}
  sizes="(max-width: 1024px) 400px, 1024px"
  alt="Provider deployment with impact on consumer"
  class="mx-auto"
/>
...
This is [a core functionality](https://docs.pact.io/pact_broker/advanced_topics/pending_pacts), and somehow confusing. Let's try to clarify its purpose.
...
You can find more information in [PactFlow documentation here](https://docs.pactflow.io/docs/workshops/org_scale/), or if you have time you can even [watch a full bank case study we've done with PactFlow](https://www.youtube.com/watch?v=LyVSmRtwFkc&list=PLdCQaMqIu9qxa8O-R-yi__JSkf_ebFZp3&index=1&t=22s).
