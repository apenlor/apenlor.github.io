...
image: ~/assets/images/cover-pactflow-selfhosted-saas.png
...
import diagramPactflowAwsArchitecture from "~/assets/images/diagram-pactflow-aws-architecture.png";
...
<Image
  src={diagramPactflowAwsArchitecture}
  widths={[400, 1024]}
  sizes="(max-width: 1024px) 400px, 1024px"
  alt="PactFlow AWS sample architecture"
  class="mx-auto"
/>
...
If you want to go deeper into this topic, you can always review the [PactFlow official documentation](https://docs.pactflow.io/docs/on-premises/system-requirements/).
...
You can find more information in [this PactFlow official article](https://docs.pactflow.io/docs/workshops/org_scale/), or even [watch in YouTube the video that is being summarized in the article.](https://www.youtube.com/watch?v=LyVSmRtwFkc)
...
You can read more about the support policy [here](https://docs.pactflow.io/docs/on-premises/support-policy/).
...
- SaaS PactFlow is fully **hosted in AWS ap-southeast-2 region** (Sydney, Australia), meaning that it's protected by all [the AWS data center security controls](https://aws.amazon.com/compliance/data-center/controls/).
...
- **Communication is encrypted in transit and at rest**, including the storage in S3 using AES-256 (considered as [enough for TOP SECRET data by the NSA](https://en.wikipedia.org/wiki/Advanced_Encryption_Standard#Security)).
...
- The whole platform **complies with [CIS IG 1](https://www.cisecurity.org/controls/implementation-groups/ig1) policies** and is looking to [SOC2 attestation](https://www.aicpa.org/resources/landing/system-and-organization-controls-soc-suite-of-services) by 2023 Q4.

If you want to have more information about security you can read this entry: [PactFlow Security.](https://pactflow.io/security/)
...
<div class="overflow-x-auto my-8">
  <table class="w-full text-sm text-left border-collapse">
    <thead>
      <tr
        class="border-b-2"
        style="border-color: var(--aw-color-primary); background: rgba(0,0,0,0.04);"
      >
        <th class="px-4 py-3 font-semibold"></th>
        <th class="px-4 py-3 font-semibold text-center">SaaS</th>
        <th class="px-4 py-3 font-semibold text-center">Self-Hosted Cloud</th>
    ...
    <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
      <tr>
        <td class="px-4 py-3 font-bold">Implementation</td>
        <td class="px-4 py-3 text-center">
          <StatusBadge color="green">Not your responsibility.</StatusBadge>
        </td>
        <td class="px-4 py-3 text-center">
          <StatusBadge color="yellow">Your responsibility.</StatusBadge>
        </td>
        <td class="px-4 py-3 text-center">
          <StatusBadge color="yellow">Your responsibility.</StatusBadge>
        </td>
      ...
      <tr>
        <td class="px-4 py-3 font-bold">Scalability</td>
        <td class="px-4 py-3 text-center">
          <StatusBadge color="green">Not your responsibility.</StatusBadge>
        </td>
        <td class="px-4 py-3 text-center">
          <StatusBadge color="yellow">
            Simple, but you will be responsible.
          </StatusBadge>
        </td>
        <td class="px-4 py-3 text-center">
          <StatusBadge color="red">Limited by physical resources.</StatusBadge>
        </td>
      </tr>
      <tr>
        <td class="px-4 py-3 font-bold">Costs</td>
        <td class="px-4 py-3 text-center">
          <StatusBadge color="green">
            Easy start. Subscription model.
          </StatusBadge>
        </td>
        <td class="px-4 py-3 text-center">
          <StatusBadge color="yellow">
            Costly to start. Can be significantly improved in the long term.
          </StatusBadge>
        </td>
        <td class="px-4 py-3 text-center">
          <StatusBadge color="red">
            Keep physical resources up to date make it expensive.
          </StatusBadge>
        </td>
      </tr>
      <tr>
        <td class="px-4 py-3 font-bold">Maintenance</td>
        <td class="px-4 py-3 text-center">
          <StatusBadge color="green">Not your responsibility.</StatusBadge>
        </td>
        <td class="px-4 py-3 text-center">
      ...
      <tr>
        <td class="px-4 py-3 font-bold">Support</td>
        <td class="px-4 py-3 text-center">
          <StatusBadge color="green">Not your responsibility.</StatusBadge>
        </td>
        <td class="px-4 py-3 text-center">
          <StatusBadge color="yellow">
            Cloud platform support on your side.
          </StatusBadge>
        </td>
        <td class="px-4 py-3 text-center">
          <StatusBadge color="yellow">
            Platform support on your side.
          </StatusBadge>
        </td>
      </tr>
      <tr>
        <td class="px-4 py-3 font-bold">Security</td>
        <td class="px-4 py-3 text-center">
          <StatusBadge color="yellow">Safer than popular belief.</StatusBadge>
        </td>
        <td class="px-4 py-3 text-center">
          <StatusBadge color="green">Control over data.</StatusBadge>
        </td>
        <td class="px-4 py-3 text-center">
          <StatusBadge color="green">
            Control over data, network and physical servers.
          </StatusBadge>
        </td>
      </tr>
    </tbody>
